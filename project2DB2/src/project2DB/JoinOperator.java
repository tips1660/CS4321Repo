...
public class JoinOperator extends Operator {
	...
	public JoinOperator(Operator lOp, List<Join> jList, HashMap<String, Expression> solo, HashMap<String, Expression> join, ArrayList<Expression> rejected) throws FileNotFoundException {
		joinList = jList;
